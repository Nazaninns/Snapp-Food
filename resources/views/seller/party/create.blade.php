...
<div class="container">
    ...
    <form action="{{route('party.submit',$food)}}" method="post" class="food-form bg-gray-200" enctype="multipart/form-data">
        @csrf
        <div class="food-card">
            <h2>{{$food->name}}</h2>
        ...
        <input type="number" id="foodName" name="count" placeholder="Enter food number to add">
        ...
        <input type="number" id="foodDescription" name="percent" placeholder="Enter your percent ">
        <div class="text-red-600">
            @error('percent')
            {{$message}}
            @enderror
        ...
        <button class="btn-grad border border-gray-700 bg-gray-700 text-white rounded-md px-4 py-2 mt-2
                ...
                style="margin-top: 10px;"
                 type="submit">Create Food Party
        </button>
        {{--        <a class="p-3.5 bg-indigo-400 text-red-300" href="{{route('party.edit',$food)}}">edit</a>--}}
    </form>
</div>
</body>
</html>
