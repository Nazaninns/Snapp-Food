...
<div class="container">
    ...
    <form action="{{route('party.update',$food,$foodParty)}}" method="post" class="food-form bg-gray-200" enctype="multipart/form-data" >
        @csrf
        <div class="food-card ">
            <h2>{{$food->name}}</h2>
        ...
        <button class="btn-grad border border-gray-700 bg-gray-700 text-white rounded-md px-4 py-2 mt-2
            ...
            style="margin-top: 10px" type="submit">Create Food Party</button>
    </form>
</div>
</body>
</html>
