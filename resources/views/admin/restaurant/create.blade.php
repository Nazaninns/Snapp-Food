...
<head>
    ...
    <title>Restaurant Category Create</title>
...
<nav class="header">
    ...
    <h1>Create Restaurant Category </h1>
    <div></div>
</nav>
<div class="container">
    <!-- Food Card Creation Form -->
    <form action="{{route('admin.restaurant_category.store')}}" method="post" class=" bg-gray-50 food-form"
        ...
        <button class="btn-grad border border-gray-700 bg-gray-700 text-white rounded-md px-4 py-2 mt-2
            ...
            style="margin-top:10px" type="submit">Create</button>
    </form>
</div>
</body>
</html>
