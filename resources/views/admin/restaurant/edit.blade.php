...
<nav class="header">
    ...
    <h1>Edit Restaurant Category</h1>
    <div></div>
</nav>
<div class="container">
    <!-- Food Card Creation Form -->
    <form class="bg-gray-50 food-form" action="{{route('admin.restaurant_category.update',$restaurantCategory)}}" method="post"
          enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <label for="foodName">Restaurant Name</label>
        <input type="text" id="foodName" name="name" value="{{$restaurantCategory->name}}" required>
