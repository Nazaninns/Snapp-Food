...
<div class="container">
    ...
    <form method="post" action="{{route('admin.food_category.update',['food_category'=>$foodCategory])}}" class="food-form bg-gray-50">
        @csrf
        @method('PATCH')
        <label for="foodName">Food Name</label>
        <input type="text" id="foodName" name="name" value="{{$foodCategory->name}}" >
