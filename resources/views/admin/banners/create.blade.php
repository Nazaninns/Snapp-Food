...
<head>
    ...
    <title>Food Category Create</title>
...
<div class="container">
    ...
    <form action="{{route('admin.banners.store')}}" enctype="multipart/form-data" method="post" class="food-form bg-gray-50">
        @csrf
        <label for="name">Banner message</label>
        ...
        <input type="file" id="name" name="image" placeholder="upload your image">
        <div class="text-red-600">
            @error('image')
            {{$message}}
            @enderror
